...
public class Ejercicio5 extends AppCompatActivity {
    ...
    private  static boolean contacto6 = false;
    private  static boolean contacto7 = false;
    private  static boolean contacto8 = false;
    private  static boolean contacto9 = false;
    private  static boolean contacto10 = false;
    ...
    private String getLandmarksDebugString(LandmarkProto.NormalizedLandmarkList landmarks) {
        ...
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(5))){
            contacto1=true;
        } else {
            contacto1=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(6))){
            contacto2=true;
        } else {
            contacto2=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(7))){
            contacto3=true;
        } else {
            contacto3=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(8))){
            contacto4=true;
        } else {
            contacto4=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(12))){
            contacto5=true;
        } else {
            contacto5=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(16))){
            contacto6=true;
        } else {
            contacto6=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(20))){
            contacto7=true;
        } else {
            contacto7=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(19))){
            contacto8=true;
        } else {
            contacto8=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(14))){
            contacto9=true;
        } else {
            contacto9=false;
        }
        if (isThumbNearFirstFinger(landmarks.getLandmark(4),landmarks.getLandmark(13))){
            contacto10=true;
        } else {
            contacto10=false;
        }
    ...
    private void cambiarEstado(){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                if (contacto1==true && estadoEjercicio == 0 && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1));
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto2==true && estadoEjercicio == 1 && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1));
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto3==true && estadoEjercicio == 2 && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1));
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto4==true && estadoEjercicio == 3  && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto5==true && estadoEjercicio == 4  && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto6==true && estadoEjercicio == 5  && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto7==true && estadoEjercicio == 6 && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto8==true && estadoEjercicio == 7  && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto9==true && estadoEjercicio == 8  && estado==true){
                    estadoEjercicio++;
                    textFinger.setText("Ahora toque punto "+(estadoEjercicio+1) );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
                else if (contacto10==true && estadoEjercicio == 9  && estado==true){
                    estadoEjercicio=0;
                    textFinger.setText("Ahora toque punto "+ 1 );
                    mediaPlayer2.start();
                    contadorEjercicio++;
                }
    ...
    public void finalizarEjercicio(){
        ...
        onPause();
        Intent MiIntent = new Intent(Ejercicio5.this, Pausa_Ejercicios.class);
        ...
        MiBundle.putString("idEjercicio","5");
