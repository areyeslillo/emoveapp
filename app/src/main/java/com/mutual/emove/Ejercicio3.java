...
public class Ejercicio3 extends AppCompatActivity {
    ...
    private static String getLandmarksDebugString(LandmarkProto.NormalizedLandmarkList landmarks) {
        ...
        float pseudoFixKeyPoint = landmarks.getLandmark(7).getX();
        if (landmarks.getLandmark(8).getX() <= pseudoFixKeyPoint && landmarks.getLandmark(8).getX() >= landmarks.getLandmark(5).getX())
        {
            firstFingerIsOpen = false;
        }else {
            firstFingerIsOpen = true;
        }
        pseudoFixKeyPoint = landmarks.getLandmark(11).getX();
        if (landmarks.getLandmark(12).getX() <= pseudoFixKeyPoint && landmarks.getLandmark(12).getX() >= landmarks.getLandmark(9).getX())
        {
            secondFingerIsOpen = false;
        }else {
            secondFingerIsOpen = true;
        }
        pseudoFixKeyPoint = landmarks.getLandmark(15).getX();
        if (landmarks.getLandmark(16).getX() <= pseudoFixKeyPoint && landmarks.getLandmark(16).getX() >= landmarks.getLandmark(13).getX())
        {
            thirdFingerIsOpen = false;
        }else {
            thirdFingerIsOpen = true;
        }
        pseudoFixKeyPoint = landmarks.getLandmark(19).getX();
        if (landmarks.getLandmark(20).getX() <= pseudoFixKeyPoint && landmarks.getLandmark(20).getX() >= landmarks.getLandmark(17).getX())
        {
    ...
    private void cambiarEstado(){
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                if (firstFingerIsOpen==true && secondFingerIsOpen == true && thirdFingerIsOpen == true && fourthFingerIsOpen==true ){
                    textFinger.setText("Ahora cierra la mano");
                    estadoEjercicio=1;
                }
                else if(firstFingerIsOpen!=true && secondFingerIsOpen != true && thirdFingerIsOpen != true && fourthFingerIsOpen!=true ) {
...
//                        mediaPlayer.setLooping(true);
    ...
    public void finalizarEjercicio(){
        ...
        onPause();
        Intent MiIntent = new Intent(Ejercicio3.this, Pausa_Ejercicios.class);
        ...
        MiBundle.putString("idEjercicio","3");
