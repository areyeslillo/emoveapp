...
public class Ejercicio2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(miBundle!=null){
            ...
            serie=miBundle.getString("serie");
        }
...
//                        mediaPlayer.setLooping(true);
    ...
    public void finalizarEjercicio(){
        ...
        onPause();
        Intent MiIntent = new Intent(Ejercicio2.this, Pausa_Ejercicios.class);
        Bundle MiBundle= new Bundle();
        MiBundle.putString("id",getIdPaciente());
        MiBundle.putString("serie",serie);
        ...
        MiBundle.putString("idEjercicio","2");
