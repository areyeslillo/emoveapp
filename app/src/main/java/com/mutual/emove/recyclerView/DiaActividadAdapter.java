...
public class DiaActividadAdapter extends RecyclerView.Adapter<DiaActividadAdapter.DiaActividadAdapterVh> implements Filterable {

    private List<DiaActividad> DiaActividadList;
    private List<DiaActividad> getDiaActividadListFiltered;
    private Context context;
    private SelectedUser selectedUser;
    public DiaActividadAdapter(List<DiaActividad> DiaActividadList) {
...
//        this.selectedUser = selectedUser;
    ...
    @NonNull
    @Override
    public DiaActividadAdapter.DiaActividadAdapterVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DiaActividadAdapter.DiaActividadAdapterVh holder, int position) {
